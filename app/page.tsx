  ...
  return (
    <div className={dark ? "dark" : ""}>
      <div
        ...
        style={{ backgroundColor: dark ? "#0e0e0e" : "#faf8f4", color: dark ? "#f0ede8" : "#1a1a1a" }}
      >
        {/* Navbar */}
        <nav
        ...
        <section className="px-8 sm:px-16 py-20 max-w-5xl mx-auto">
          ...
          <p className="text-lg mb-5" style={{ color: mutedColor }}>
          ...
          <div className="flex flex-wrap gap-3 mb-8">
            <a
              href="/resume.pdf"
              download="Anurinth_Wichairum_Resume_2026.pdf"
...
{/* Stats */}
        <section className="px-8 sm:px-16 py-10 max-w-5xl mx-auto">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <div
                ...
                style={{ backgroundColor: dark ? "#141414" : "#ffffff", border: `0.5px solid ${borderColor}` }}
              >
        ...
        {/* Skills */}
        <section className="px-8 sm:px-16 pb-8 max-w-5xl mx-auto">
          <p className="text-xs font-medium uppercase tracking-widest mb-5" style={{ color: subtleColor }}>
            skills
          </p>
          <div className="flex flex-wrap gap-2">
            {[
              "AWS", "Terraform", "Docker", "Kubernetes", "GitHub Actions",
              "Prometheus", "Python", "Go", "React", "Next.js",
              "Cloudflare Workers", "Google Apps Script", "Linux", "CI/CD"
            ].map((skill) => (
              <span
                key={skill}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {projects.map((p) => (
              <a
                ...
                style={{ border: `0.5px solid ${borderColor}`, backgroundColor: dark ? "#141414" : "#ffffff" }}
